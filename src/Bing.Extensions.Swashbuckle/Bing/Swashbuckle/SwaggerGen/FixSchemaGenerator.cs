...
namespace Bing.Swashbuckle.SwaggerGen
{
    /// <summary>
    /// 热修复 架构生成器问题
    /// </summary>
    internal class FixSchemaGenerator : ISchemaGenerator
    {
        ...
        public FixSchemaGenerator(SchemaGeneratorOptions generatorOptions, ISerializerDataContractResolver serializerDataContractResolver)
        {
